namespace USMoneris
{
	...
	public class TestEncTrack2Preauth
	{
	  public static void Main(string[] args)
	  {
	        ...
	        string order_id = "testencpreauth1";
            ...
            USEncTrack2PreAuth P = new USEncTrack2PreAuth(order_id, cust_id, amount, enc_track2, pos_code, device_type);
